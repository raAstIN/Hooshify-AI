...
button_1 = customtkinter.CTkButton(master=frame_1, corner_radius=50, command=open_login, text="Login", font=("montserrat", 15, "bold"), image=user_image, width=190, height=45, compound="right")
button_1.pack(pady=y_padding, padx=10)
button_2 = customtkinter.CTkButton(master=frame_1, corner_radius=50, command=open_signup, text="Sign Up", font=("montserrat", 15, "bold"), image=user_image, width=190, height=45, compound="right")
button_2.pack(pady=y_padding, padx=10)
button_3 = customtkinter.CTkButton(master=frame_1, corner_radius=50, command=disabled_action, text="Language", font=("montserrat", 15, "bold"), image=internet_image, width=190, height=45, compound="right")
button_3.pack(pady=y_padding, padx=10)
button_3.configure(state="disabled")
button_4 = customtkinter.CTkButton(master=frame_1, corner_radius=50, command=disabled_action, text="About Us", font=("montserrat", 15, "bold"), image=team_image, width=190, height=45, compound="right")
button_4.pack(pady=y_padding, padx=10)
button_4.configure(state="disabled")
button_5 = customtkinter.CTkButton(master=frame_1, corner_radius=50, command=disabled_action, text="Notice", font=("montserrat", 15, "bold"), image=question_image, width=190, height=45, compound="right")
